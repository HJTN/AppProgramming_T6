...
class HamburgerOrderFragment: Fragment() {
    ...
    override fun onCreateView(
        ...
        dataSet.add(Item(root+"/Single/Burger/DoubleBulgogiBurger","더블 불고기 버거", 4400, R.drawable.bigmacburger))
        dataSet.add(Item(root+"/Single/Burger/DoubleBeefMeetChiliBurger","더블 비프 미트칠리 버거", 8300, R.drawable.quarterpoundercheeseburger))
        // 세트
